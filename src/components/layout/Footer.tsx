...
export default function Footer() {
  return (
    <footer className="bg-[#1a1f2b] text-gray-400 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/bennes" className="hover:text-white transition">Bennes</Link></li>
              <li><Link href="/devis" className="hover:text-white transition">Devis</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="tel:0321000000" className="hover:text-white transition flex items-center gap-2">
            ...
            <div className="flex gap-3 mt-4">
              <a
                ...
                className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#0f5e3e] hover:text-white transition group"
                aria-label="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#25D366] hover:text-white transition group"
                aria-label="WhatsApp"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
