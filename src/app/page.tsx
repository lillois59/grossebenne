...
export default function Home() {
  ...
  const IconTruck = () => (
    <svg className="w-8 h-8 text-[#0f5e3e]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 18a2 2 0 01-2 2m10-2a2 2 0 01-2 2m-6-2a2 2 0 01-2 2m10-2a2 2 0 01-2 2m-6-2a2 2 0 01-2 2m-6-2a2 2 0 01-2-2v-8a2 2 0 012-2h12a2 2 0 012 2v8a2 2 0 01-2 2m0 0a2 2 0 01-2-2v-4a2 2 0 012-2m0 0V6a2 2 0 012-2h4a2 2 0 012 2v12a2 2 0 01-2 2" />
    </svg>
  );
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 py-12">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              ...
              <a href="tel:+33642240841" className="flex items-center gap-2 text-white px-6 py-3.5 rounded font-semibold border border-white/20 hover:bg-white/5 transition">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-500 mb-6">
                NordBennes.fr intervient sur l'ensemble du territoire, avec une base opérationnelle à Arras.
              </p>
