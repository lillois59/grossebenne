            ...
            <div className="lg:col-span-2 bg-gray-50 p-8 rounded-sm">
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full px-4 py-3 bg-white border border-gray-200 rounded-sm text-sm focus:ring-1 focus:ring-[#0f5e3e] focus:border-[#0f5e3e] outline-none transition" placeholder="Votre message..."></textarea>
                </div>
                <button type="submit" className="w-full bg-[#0f5e3e] text-white py-3 rounded-sm font-semibold hover:bg-[#1a7a52] transition">
                  Envoyer
                </button>
              </form>
            </div>
